...
wloss=1
layers=2
EXP="id4_dynamic_envi_gelu_layers${layers}_encdec_restrain_w${wloss}_c${closs}_penal${penal}_k${kmin}_k${kmax}_2506"
special=" --control-gate-layers ${layers} --observe-encoder --control-nonlin gelu --observation-index 4 --restrain-writer "
