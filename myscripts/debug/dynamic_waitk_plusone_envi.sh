...
wloss=1
layers=1
EXP="plusone_envi_layers${layers}_dynamic_waitk_w${wloss}_c${closs}_penal${penal}_k${kmin}_k${kmax}_2506"
special=" --control-gate-layers ${layers} "
...
arch=plusone_dynamic_simultaneous_transformer_small
