...
wloss=1
layers=2
EXP="frozen_dynamic_id3_envi_gelu_layers${layers}_w${wloss}_c${closs}_penal${penal}_k${kmin}_k${kmax}_2606"
special=" --control-gate-layers ${layers} --control-nonlin gelu --freeze-writer --observation-index 3 "
