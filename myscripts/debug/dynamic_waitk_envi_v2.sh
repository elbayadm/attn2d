...
wloss=1
layers=2
EXP="dynamic_envi_gelu_layers${layers}_detach_encdec_restrain_w${wloss}_c${closs}_penal${penal}_k${kmin}_k${kmax}_2506"
special=" --control-gate-layers ${layers} --control-detach --observe-encoder --control-nonlin gelu --restrain-writer "
