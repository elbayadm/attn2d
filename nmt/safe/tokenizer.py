...
class Tokenizer:
    ...
    @staticmethod
    def build_dictionary(filename, tokenize=tokenize_line, add_eos=True):
        dict = Dictionary(add_eos=add_eos)
        Tokenizer.add_file_to_dictionary(filename, dict, tokenize, add_eos)
        dict.finalize()
        return dict

    @staticmethod
    def add_file_to_dictionary(filename, dict, tokenize, add_eos=True):
