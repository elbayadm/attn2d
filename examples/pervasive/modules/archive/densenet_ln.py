...
class DenseNetLN(nn.Module):
    ...
    def forward(self, x, incremental_state=None):
        ...
        for i, layer in enumerate(self.dense_layers):
            x = layer(features, incremental_state)
            features.append(x)
...
class _DenseLayer(nn.Module):
    def __init__(self, num_input_features, args):
        ...
        self.norm1 = PervasiveLayerNorm(num_input_features)
        ...
        self.norm2 = PervasiveLayerNorm(inter_features)
