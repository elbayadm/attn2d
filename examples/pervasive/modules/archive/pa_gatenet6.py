...
class PAGateNet6(nn.Module):
    ...
    def __init__(self, num_init_features, args):
        ...
        self.ffn_gate = _GateLayer(num_features)
        self.attn_gate = _GateLayer(num_features)
    ...
    def forward(self, x, 
        ...
        for layer in self.blocks:
            ...
            if isinstance(layer, _ConvLayer):
                features += self.attn_gate(xlayer)
            else:
                features += self.ffn_gate(xlayer)
