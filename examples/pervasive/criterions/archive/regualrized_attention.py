...
@register_criterion('regularized_attention')
class RegularizedAttention(FairseqCriterion):

    def __init__(self, args, task):
        super().__init__(args, task)
        self.eps = args.label_smoothing
        self.alpha = args.regul_scale
    ...
    def add_args(parser):
        ...
        parser.add_argument('--regul-scale', default=0., type=float, metavar='D')
    ...
    def aggregate_logging_outputs(logging_outputs):
        ...
        return {
            ...
            'regul_loss': sum(log.get('regul_loss', 0) for log in logging_outputs) / sample_size / math.log(2),
